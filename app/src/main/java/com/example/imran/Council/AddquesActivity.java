            ...
            if (result) {
                ...
                try {
                    ...
                    if (jsonObject.getBoolean(Constant.SUCCESS)) {
                        ...
                        Intent intent = new Intent(AddquesActivity.this, AddquesActivity.class);
//
        ...
        }, AddquesActivity.this, Constant.ADD_QUESTION, params,true);
